...
af_recipe2 = Recipe(user_id=1,
                    ...
                    description=("According to chef Marcus Samuelsson, 'A "
                                 ...
                                 "Ethiopian dish-minus all the butter "
                                 "and oil."),
                    cuisine=cuisine1)
...
af_recipe3 = Recipe(user_id=1,
                    ...
                    description=("This flavorful Ethiopian-inspired chicken "
                                 "stew recipe uses Berbere, an Ethiopian "
                                 "spice blend.Store extra spice mix covered "
                                 "in a cool, dark place for "
                                 "up to two weeks. Use leftovers on salmon, "
                                 "flank steak, or chicken for fiery flavor. "
...
as_recipe1 = Recipe(user_id=1,
                    ...
                    description=("Lacinato kale ups the green in this green "
                                 "curry dish, providing a delightful textural "
                                 "contrast to "
...
as_recipe2 = Recipe(user_id=1,
                    ...
                    description=("Make-ahead tip: Mix up the glaze first "
                                 "thing in the morning, and allow the chicken "
                                 "thighs to marinate all day long in the "
                                 "refrigerator to soak up even more flavor. "
                                 "After that, getting dinner on the table "
                                 "is as simple as heating up the grill pan."),
                    cuisine=cuisine2)
...
as_recipe3 = Recipe(user_id=1,
                    ...
                    description=("Our take saves 446 calories, 22 grams of "
                                 "fat, and 1,260 milligrams of sodium over "
                                 "one serving of a leading chain's sweet "
                                 "and sour chicken."),
                    cuisine=cuisine2)
...
eu_recipe1 = Recipe(user_id=1,
                    ...
                    description=("Juicy cubes of mutton tossed with potatoes "
                                 "and seasoned with carrots, springs onions. "
                                 "It's a rich and hearty Irish feast!"),
                    cuisine=cuisine3)
